    ...
    <div class="flex flex-1 items-center gap-4">
        <div class="relative hidden max-w-md flex-1 sm:block">
            ...
            <input
                ...
                disabled
                class="w-full rounded-lg border border-gray-200 bg-gray-50 py-2 pl-10 pr-4 text-sm text-gray-500 dark:border-slate-600 dark:bg-slate-700/50 dark:text-slate-400"
            />
        </div>
    </div>

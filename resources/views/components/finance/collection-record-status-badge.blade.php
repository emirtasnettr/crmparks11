...
@php
    $badges = [
        ...
        'partial' => ['label' => 'Kısmi Tahsil Edildi', 'dot' => '🟡', 'class' => 'bg-amber-50 text-amber-700 dark:bg-amber-600/10 dark:text-amber-400'],
        'pending' => ['label' => 'Bekliyor', 'dot' => '🔴', 'class' => 'bg-red-50 text-red-700 dark:bg-red-600/10 dark:text-red-400'],
        'overdue' => ['label' => 'Vadesi Geçti', 'dot' => '⚫', 'class' => 'bg-gray-200 text-gray-800 dark:bg-slate-600 dark:text-slate-200'],
    ];

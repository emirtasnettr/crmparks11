        ...
        <div class="space-y-4 px-6 py-4" x-show="selected">
            <div class="flex items-center gap-3">
                <template x-if="selected?.photo_url">
                    <img :src="selected.photo_url" alt="" class="h-12 w-12 shrink-0 rounded-full border border-gray-200 object-cover dark:border-slate-700" />
                </template>
                <template x-if="!selected?.photo_url">
                ...
                <div>
                    <p class="font-semibold text-gray-900 dark:text-white" x-text="selected?.full_name"></p>
                    <p class="text-sm text-gray-500 dark:text-slate-400" x-text="selected?.agency_name || 'Esnaf Kurye'"></p>
                </div>
            </div>
            ...
            <dl class="space-y-3 text-sm">
                ...
                <div class="flex justify-between gap-4">
                    ...
                    <dd class="font-medium text-gray-900 dark:text-white" x-text="selected?.vehicle_type_label"></dd>
                </div>
                <div class="flex justify-between gap-4">

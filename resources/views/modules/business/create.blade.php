...
@section('content')
<div
    x-data="businessForm(@js($districtsByCity), @js(['first_invoice_date' => \App\Modules\Business\Data\BusinessFormData::defaultFirstInvoiceDate()]), false, @js(\App\Modules\Business\Support\BusinessFeatures::earningsEnabled()), @js(route('businesses.geocode', absolute: false)), @js(route('businesses.neighborhoods', absolute: false)))"
    class="max-w-5xl"
>

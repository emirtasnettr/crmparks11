...
>
    ...
    <div x-show="activeModal === 'bulk'" x-transition class="relative w-full max-w-lg rounded-xl border border-gray-200 bg-white shadow-xl dark:border-slate-700 dark:bg-slate-800">
        ...
        <form method="POST" action="{{ route('businesses.earnings.import') }}" enctype="multipart/form-data" class="space-y-4 px-6 py-4">
            @csrf
            ...
            <x-ui.button href="{{ route('businesses.earnings.template') }}" variant="secondary" class="w-full">

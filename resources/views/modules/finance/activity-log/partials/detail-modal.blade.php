    ...
    <div x-show="activeModal" x-transition class="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-xl border border-gray-200 bg-white shadow-xl dark:border-slate-700 dark:bg-slate-800">
        <div class="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4 dark:border-slate-700 dark:bg-slate-800">
            <div>
                ...
                <p class="mt-0.5 text-xs text-gray-500 dark:text-slate-400">Salt okunur denetim kaydı</p>
            </div>
            ...
            <div class="space-y-4 px-6 py-4">
                <dl class="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
                    <div>
                        ...
                        <dd class="mt-0.5 font-medium text-gray-900 dark:text-white" x-text="selected.action_type_label"></dd>
                    </div>
                    <div>
                ...
                <div>
                    <p class="mb-2 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-slate-400">Eski Veri (JSON)</p>
                ...
                <div>
                    <p class="mb-2 text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-slate-400">Yeni Veri (JSON)</p>
                ...
                <div class="rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-800/50">
                    <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-slate-400">İşlem Açıklaması</p>
                ...
                <div class="flex flex-wrap justify-end gap-2 border-t border-gray-200 pt-4 dark:border-slate-700">
                    <template x-if="selected.related_route">
                        <a :href="selected.related_route" class="inline-flex items-center rounded-lg bg-primary-600 px-4 py-2 text-sm font-medium text-white hover:bg-primary-700">
                            İlgili Kayıta Git
                        </a>
                    </template>

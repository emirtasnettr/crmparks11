...
<div class="mx-auto max-w-4xl">
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div class="flex flex-wrap gap-2">
            <x-ui.button href="{{ route('form-builder.submissions.index', $form['id']) }}" variant="secondary">Başvurulara Dön</x-ui.button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div class="space-y-6 lg:col-span-2">
            ...
            <x-ui.card>
                ...
                <form method="POST" action="{{ route('form-builder.submissions.notes.store', [$form['id'], $submission['id']]) }}" class="mb-6 space-y-3">
                    @csrf
                    <div>

...
>
    ...
    >
        <div class="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4 dark:border-slate-700 dark:bg-slate-800">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Acente Detayı</h3>
        ...
        <div class="space-y-4 px-6 py-4" x-show="selected">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="font-semibold text-gray-900 dark:text-white" x-text="selected?.display_name || selected?.brand_name || selected?.company_name"></p>
                    <p class="text-sm text-gray-500 dark:text-slate-400" x-text="selected?.company_name"></p>
                    <p class="text-sm text-gray-500 dark:text-slate-400" x-text="selected?.authorized_person"></p>
                </div>
            </div>
            ...
            <dl class="space-y-3 text-sm">
                ...
                <div class="flex justify-between gap-4">
                    ...
                    <dd class="font-medium text-gray-900 dark:text-white" x-text="selected?.active_businesses"></dd>
                </div>
                <div class="flex justify-between gap-4">
            ...
            <div class="grid grid-cols-2 gap-2 pt-2">
                ...
                <a :href="selected?.couriers_url" class="rounded-lg border border-gray-200 px-3 py-2 text-center text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-slate-600 dark:text-slate-300 dark:hover:bg-slate-700">Kuryeler</a>

...
<div class="max-w-6xl">
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div class="flex shrink-0 flex-wrap gap-2">
            <x-ui.button href="{{ route('agencies.documents.download', $document['id']) }}" variant="secondary">
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                İndir
            </x-ui.button>
            <x-ui.button href="{{ route('agencies.show', $document['agency_id']) }}" variant="secondary">Acente Kartı</x-ui.button>
        </div>
    </div>
    ...
    <x-ui.card title="Dosya Önizleme" class="mt-6">
        <div class="flex min-h-[420px] flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 p-8 dark:border-slate-600 dark:bg-slate-800/50">
            ...
            <x-ui.button href="{{ route('agencies.documents.download', $document['id']) }}" variant="secondary" class="mt-4" size="sm">
                Dosyayı İndir
            </x-ui.button>
        </div>
    </x-ui.card>
